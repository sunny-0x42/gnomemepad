# Prepare deploy/sapphire-modules: hub + profile for modular upgrades.
param(
...
$OUT = Join-Path $ROOT "deploy\sapphire-modules"
...
Write-Host "Prepared Sapphire modules:"
Prepare-Realm "hub" "hub"
Prepare-Realm "profile" "profile"
Write-Host "Dir: $OUT"
